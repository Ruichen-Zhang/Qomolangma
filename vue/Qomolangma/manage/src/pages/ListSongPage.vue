    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="select_word" size="mini" placeholder="请输入书籍名" class="handle-input"></el-input>
        ...
        <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="tableData" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="作者-书籍" align="center"></el-table-column>
        ...
        <el-dialog title="添加书籍" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form :model="registerForm" ref="registerForm" label-width="80px" action="" id="tf">
                <el-form-item prop="singerName" label="作者名字" size="mini">
                    <el-input v-model="registerForm.singerName" placeholder="作者名字"></el-input>
                </el-form-item>
                <el-form-item prop="songName" label="书籍名字" size="mini">
                    <el-input v-model="registerForm.songName" placeholder="书籍名字"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
        ...
        <el-dialog title="批量添加" :visible.sync="centerDialogVisible2" width="800px" center>

            <el-button type="primary" size="mini" @click="delAll" class="button1">批量添加</el-button>
