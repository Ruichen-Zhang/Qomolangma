    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" size="mini" @click="centerDialogVisible = true" class="button1">添加作者</el-button>
            </div>
        </div>
        <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="章节管理" width="110" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="songEdit(scope.row.id,scope.row.name)">章节管理</el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog title="修改作者" :visible.sync="editVisible" width="400px" center>
