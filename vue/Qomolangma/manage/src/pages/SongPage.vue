<template>
    <div class="table">
        ...
        <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="作者-章节名" width="120" align="center"></el-table-column>
        ...
        <el-dialog title="修改章节" :visible.sync="editVisible" width="400px" center>
            <el-form :model="form" ref="form" label-width="80px">
                <el-form-item prop="name" label="作者-章节" size="mini">
                    <el-input v-model="form.name" placeholder="作者-章节"></el-input>
                </el-form-item>
